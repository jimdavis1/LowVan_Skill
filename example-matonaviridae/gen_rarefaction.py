...
only), so this is the Matonaviridae-local renderer. Palette is the report
...
WORK = os.path.abspath(os.path.join(W, '..', '..'))
d = json.load(open(os.path.join(WORK, 'rarefaction.json')))
...
HTML = f'''<title>Rubella Vocabulary Saturation</title>
...
<div class="wrap">
 <header>
  <div class="eyebrow">LowVan &middot; Matonaviridae module &middot; 16 September 2026</div>
...
'''
out = os.path.join(WORK, 'Reports', 'matonaviridae_rarefaction.html')
